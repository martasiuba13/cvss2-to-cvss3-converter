...
# ---------------------------------------------------
# Podział danych na X (cechy) i y_AC

# X: kolumny 0–56 (57 cech -  50 słów + 7 elementów CVSSv2)
X = df.iloc[:, 0:57]

# y_AC: kolumna 58 -> AC (CVSS 3.1), 2 klasy: 0 (LOW), 1 (HIGH)
y = df.iloc[:, 58]

print("\nKształt X:", X.shape)
print("Kształt y (AC):", y.shape)
...
# Skalowanie danych wejściowych (X)
...
# Budowa modelu sieci neuronowej dla AC (2 klasy)


model = Sequential([
    Dense(64, activation='relu', input_shape=(57,)),
    Dense(32, activation='relu'),
    Dense(2, activation='softmax')   # TERAZ 2 NEURONY -> klasa 0 i 1
])
...
# -------------------------------------------
# Wagi klas (jeśli AC jest niezbalansowane)
...
print("\nWyniki na zbiorze testowym dla AC:")
...
print("\nRaport klasyfikacji (AC):")
print(classification_report(y_test, y_pred))

#----------------------------------
# Zapis modelu AC do pliku .h5

model.save("model_ac.h5")
print("\nModel AC zapisano do pliku: model_ac.h5")
