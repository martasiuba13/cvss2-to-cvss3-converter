...
# -----------------------------------------
# 2. Podział danych na X (cechy) i y_C (Confidentiality v3.1)

# X: 57 cech (kolumny 0–56)
X = df.iloc[:, 0:57]

# C: kolumna 62 (CVSS 3.1) – 3 klasy: 0 (NONE), 1 (LOW), 2 (HIGH)
y = df.iloc[:, 62]

print("\nKształt X:", X.shape)
print("Kształt y (C):", y.shape)

print("\nLiczność klas w C (cały zbiór):")
...
#-----------------------------------------------
#  Budowa modelu sieci neuronowej dla C (3 klasy)
...
# -------------------------------------------------
# Wagi klas (C) – balansowanie danych
...
print("\nWyniki na zbiorze testowym dla C:")
...
print("\nRaport klasyfikacji (C):")
print(classification_report(y_test, y_pred))

# -----------------------------
# Zapis modelu C do pliku .h5

model.save("model_c.h5")
print("\nModel C zapisano do pliku: model_c.h5")
